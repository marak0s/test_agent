...
def build_approval_message(topic_title: str, content_item_id: str, draft_id: str, goal: str, body_text: str, review_summary: str | None = None) -> str:
...
def inline_keyboard(draft_id: str, content_item_id: str) -> dict:
    return {"inline_keyboard": [[{"text": a, "callback_data": f"{a}|{draft_id}|{content_item_id}"} for a in ACTIONS if a != "help"]]}
